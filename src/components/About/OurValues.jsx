...
const OurValues = () => {
    ...
    const valueSubtitle = {
        color:'#000',
        fontSize:['14px', '14px', '14px', '32px', '36px', '40px'],
        fontFamily:['var(--garnett-regular)'],
        lineHeight:'normal',
        fontWeight:['600','600','600','400','400','400'],
        mb:['14px','14px','14px','20px','20px','20px'],
        mt:'10px'
    }
    const valueSubText ={
        fontSize:['9px', '10px', '11px', '20px', '20px', '20px'],
        fontWeight:'400',
        color:'#333',
        lineHeight:'normal',
        fontFamily:'var(--foundersGrotesk-regular)'
            ...
            {/* Values Short Desccription With tITLE  */}
                <Box maxW={['100%', '100%', '100%', '75%', '75%', '75%']} ml={['auto', 'auto', 'auto', 'auto', 'auto', 'auto']} pt={['20px', '20px', '20px', '100px']}>
                        ...
                        <Box display={['block','block','block','grid','grid','grid']} rowGap={'104px'} columnGap={'40px'} gridTemplateColumns={'repeat(2,1fr)'}>
                            {/*  Value One */}
                            <Flex  mb={['12px','12px','12px','0px','0px','0px']} padding={['8px 16px 18px','8px 16px 18px','8px 16px 18px','0px','0px','0px']} bg={['#F5F5F5','#F5F5F5','#F5F5F5','#fff','#fff','#fff']}>
                                    <Box mr={'26px'} pt={'10px'}>
                                        <svg  xmlns="http://www.w3.org/2000/svg" style={{...svgMobile}} width="37" height="37" viewBox="0 0 37 37" fill="none">
