...
import BgImage1 from '../../../assets/Service/SingleService/LetsWorkTogether/1.svg';
import BgImage2 from '../../../assets/Service/SingleService/LetsWorkTogether/2.svg';

const LetsWorkTogether = () => {
  return (
    <Box bg={'#00342B'} p={['80px 0','80px 0','80px 0','80px 0','80px 0','80px 0']} position={'relative'}>
      <Box>
