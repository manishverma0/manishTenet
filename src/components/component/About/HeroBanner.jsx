...
import bannerGif from '../../assets/About/banner/BannerGif.gif';
...
const HeroBanner = () => {
  ...
  return (
    <Box  padding={['95px 0 120px','90px 0 120px','90px 0 120px','56px 0 222px','56px 0 222px','56px 0 222px']}  overflow={'hidden'} position="relative">
      {/* BackGround Video */}
      ...
      <Container maxWidth={["100%", "100%", "100%", "90%", "90%", "90%"]} m={'0 auto'} zIndex={2} position={'relative'}>
        ...
        <Flex display={['block','block','block','flex','flex','flex']}>
          ...
          <Box width={['100%', '100%', '100%', '50%', '50%', '50%']}>
            <Image src={AboutHeroImg} w={'100%'} h={'100%'} objectFit={'fill'} />
          </Box>
        </Flex>
      </Container>
    </Box>
